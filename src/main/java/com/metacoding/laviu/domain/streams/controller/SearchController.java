...
public class SearchController {
    ...
    public ResponseEntity<?> getSearchUsers(@RequestParam(required = false) String query) {
        ...
        //2.get
        List<UsersResponse.SearchDTO> respDTO = usersService.getSearchUsers(query, user);
    ...
    public ResponseEntity<?> getSearchStreams(@RequestParam(required = false) String query) {
        ...
        //2.get
        List<StreamsResponse.StreamDTO> respDTO = streamsService.getSearchStreams(query);
